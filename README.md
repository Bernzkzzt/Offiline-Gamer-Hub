...
1. Definir a arquitetura Android (ex.: MVVM + Room + armazenamento interno).
2. Especificar o tema global e as animações de troca de cores.
3. Criar protótipo das telas principais (menu, perfil local, personalização).
4. Implementar módulos iniciais (perfil local, anotações, calendário).
